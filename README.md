...
The project was functional untill recent changes to riot api where they also blocked front end access as here on top of other changes, I tried to make it work useing local server in node.js to no avail.
